        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <h3 className="font-bold text-lg text-secondary mb-2">Booking for :{name}</h3>
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-4 justify-items-center'>
                        <input disabled type="text" value={format(date, 'PP')} class="input input-bordered input-secondary w-full max-w-xs" />
